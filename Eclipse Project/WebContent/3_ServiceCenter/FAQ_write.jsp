...
<%
	...
	if(request.getParameter("faq_number") != null){
		faq_number = Integer.parseInt(request.getParameter("faq_number"));
	}
...
<body>
    ...
    <section>
        <form name="form1" method="post" action="FAQ_write_ok.jsp">
            <h3 class="deco1">자주하는 질문 작성하기</h3><br><br>
            <input type="hidden" name="notice_number" value="<%= faq_number %>">
            <table>
                <tr>
                    <td class="mg">글 제 목</td>
                    <td><input type="text" size="58" name="faq_title"></td>
                </tr>
                <tr>
                    <td class="mg">글 내 용</td>
                    <td><textarea rows="9" cols="60" name="faq_content"></textarea></td>
                </tr>
            </table><br><br>
