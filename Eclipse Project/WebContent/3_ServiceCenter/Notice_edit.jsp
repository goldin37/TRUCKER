...
<%
	...
	Notice notice = db.getBoard(notice_number, false);
%>
<html>
<head>
	<meta charset="EUC-KR">
...
<body>
    ...
    <section>
        <form name="form" method="post" action="Notice_edit_ok.jsp">
            <h3 class="deco1">공지사항 수저하기</h3><br><br>
            <input type="hidden" name="notice_number" value="<%= notice_number %>">
            <table>
                <tr>
                    <td class="mg">글 제 목</td>
                    <td><input type="text" size="58" name="notice_title" value="<%= notice.getNotice_title() %>"></td>
                </tr>
                <tr>
                    <td class="mg">글 내 용</td>
                    <td><textarea rows="9" cols="60" name="notice_content">
