...
<body>
    ...
    <section>
        <form name="form" method="post" action="Notice_write_ok.jsp">
            <h3 class="deco1">공지사항 작성하기</h3><br><br>
            <input type="hidden" name="notice_number" value="<%= notice_number %>">
            <table>
                <tr>
                    <td class="mg">글 제 목</td>
                    <td><input type="text" size="58" name="notice_title"></td>
                </tr>
                <tr>
                    <td class="mg">글 내 용</td>
                    <td><textarea rows="9" cols="60" name="notice_content"></textarea></td>
                </tr>
            </table><br><br>
