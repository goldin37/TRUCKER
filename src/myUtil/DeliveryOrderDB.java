...
public class DeliveryOrderDB {
	...
	public ArrayList<DeliveryOrder> listOrder_onlyorder(String pageNumber){
		//order에 해당하는 orderlist를 불러오는 메소드
		...
		try {
			...
			stmt = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
			sql = "select * from delivery_order where order_state='order'";
			rs = stmt.executeQuery(sql);
	...
	public ArrayList<DeliveryOrder> listOrder_onlycomplete(String pageNumber){
		//order에 해당하는 orderlist를 불러오는 메소드
		...
		try {
			...
			stmt = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
			sql = "select * from delivery_order where order_state='complete'";
			rs = stmt.executeQuery(sql);
