...
public class DeliveryOrderDB {
	...
	public int createOrder(String truck_type, String cargo_type, String cargo_weight, String cargo_help, String cargo_spec, String from_where, String from_spec, String depart_time, String to_where, String to_spec, String distance, String time, String ETA, String recommend_cost, String fix_cost, String customer_name, String customer_telephone) throws Exception{
		...
		try {
			...
			//?†ë?Ü° ?Ñ±Í≥? Î©îÏãúÏß?
			System.out.println("ÎßàÏ?Îß? order_id : " + max_order_id);
			System.out.println("?Éà?Ñ± order_id : " + create_order_id);
			System.out.println("DB Ï°∞Ìöå ?Ñ±Í≥?");
		} catch(Exception e) {
			System.out.println("DB Ï°∞Ìöå ?ã§?å®");
			e.printStackTrace();
		}
		//Ï£ºÎ¨∏ insert
		try {
			...
			//?Ñ±Í≥? Î©îÏãúÏß?
			System.out.println("Ï£ºÎ¨∏ ?Éù?Ñ± ?Ñ±Í≥?");
			re = create_order_id;
		} catch(Exception e){
			System.out.println("Ï£ºÎ¨∏ ?Éù?Ñ± ?ã§?å®");
			e.printStackTrace();
		}
		
		//?Éù?Ñ±?ïú order_id Î¶¨ÌÑ¥
		return re;
	}
